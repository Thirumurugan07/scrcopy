...
#include <assert.h> // Include the assert.h header for assertion macros
#include <stdint.h> // Include the stdint.h header for integer types
...
static void sc_packet_source_sinks_close_firsts(struct sc_packet_source* source, unsigned count) {
    while (count) {
