...
get_optimal_size(struct sc_size current_size, struct sc_size content_size,
    ...
    if (!within_display_bounds ||
        ...
        if (current_size.width < display_size.width)
            window_size.width = current_size.width;
        else
            window_size.width = display_size.width;

        if (current_size.height < display_size.height)
            window_size.height = current_size.height;
        else
            window_size.height = display_size.height;
    }
