...
static inline bool is_started(struct sc_fps_counter* counter) {
    return counter->started;
}

// Function to set the started state of the fps counter
static inline void set_started(struct sc_fps_counter* counter, bool started) {
